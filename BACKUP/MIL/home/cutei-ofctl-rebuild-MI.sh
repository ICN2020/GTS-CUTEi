...
ovs-ofctl add-flow virbr10 priority=10,arp,nw_dst=160.80.221.99,actions=output:$vport_cutei
ovs-ofctl add-flow virbr10 priority=10,ip,nw_dst=160.80.221.99,actions=output:$vport_cutei
